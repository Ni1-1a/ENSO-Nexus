...
# постоянная ссылка-вход: обновить страницу-редирект на GitHub Pages
bash scripts/update-public-link.sh || echo "(не удалось обновить постоянную ссылку — см. выше)"
