...
const LAYERS = [
  ...
  },
  {
    ...
    match: /сет[ие]|кабел|водопровод|канализ|газопровод|газоснаб|теплотрасс|теплосет|лэп|электроснаб|лини[яи]\s*связи|utility|network/i,
  ...
  },
  {
    ...
    match: /дорог|проезд|проезжая|road|driveway/i,
  ...
  },
  {
    ...
    match: /благоустр|озелен|газон|дерев|кустарн|клумб|landscap|green/i,
  ...
  },
  {
    ...
    match: /водоём|водоем|пруд|озер|рек[аи](?![а-яё])|канав|дренаж|ручей|болот/i,
